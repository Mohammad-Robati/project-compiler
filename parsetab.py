...
_lr_productions = [
  ...
  ('expr -> expr PLUS expr','expr',3,'p_add','test.py',50),
  ('expr -> expr MINUS expr','expr',3,'p_sub','test.py',55),
  ('expr -> MINUS expr','expr',2,'p_expr2uminus','test.py',60),
  ('expr -> expr TIMES expr','expr',3,'p_mult_div','test.py',65),
  ('expr -> expr DIV expr','expr',3,'p_mult_div','test.py',66),
  ('expr -> NUMBER','expr',1,'p_expr2NUM','test.py',78),
  ('expr -> LPAREN expr RPAREN','expr',3,'p_parens','test.py',83),
]
